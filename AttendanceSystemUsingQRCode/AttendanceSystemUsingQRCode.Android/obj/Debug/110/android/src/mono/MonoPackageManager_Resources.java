...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AttendanceSystemUsingQRCode.Android.dll" comes first in this list. */
		"AttendanceSystemUsingQRCode.Android.dll",
		"AttendanceSystemUsingQRCode.dll",
